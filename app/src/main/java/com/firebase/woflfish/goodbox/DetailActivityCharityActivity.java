...
public class DetailActivityCharityActivity extends Fragment {
    View myView;
    ...
    private Button btnViewDonation;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.detail_charity_activity_charity_activity, container, false);
        imageViewLoad = (ImageButton)myView.findViewById(R.id.imageLoad2);
        txtdescription = (TextView)myView.findViewById(R.id.txtfulldescription_detail_activity_charity) ;
        btnViewDonation = (Button)myView.findViewById(R.id.btn_view_donation);
        imgActivity1 = (ImageView)myView.findViewById(R.id.imagev_activity1);
        imgActivity2 = (ImageView)myView.findViewById(R.id.imagev_activity2);
        imgActivity3 = (ImageView)myView.findViewById(R.id.imagev_activity3);
        ...
        imageViewLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                editor.putString("IdAct", uids.get(position));
                editor.apply();
        ...
        btnViewDonation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(data.get(position).getCategories().size()>0) {
                    btnViewDonation.setText("Xem lịch sử quyên góp");
                    btnViewDonation.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            SharedPreferences sharedPreferences = myView.getContext().getSharedPreferences("History", Context.MODE_PRIVATE);
                            SharedPreferences.Editor editor = sharedPreferences.edit();
                            editor.putString("actiname", data.get(position).getName());
                            FragmentManager fm = getFragmentManager();
                            fm.beginTransaction()
                                    .replace(R.id.content_frame_home_charity, new CharityViewHistoryDonationActivity())
                                    .commit();
                    ...
                    //nothing
                    btnViewDonation.setText("Hoạt động không cần quyên góp");
                }
            }
        });
        return  myView;
